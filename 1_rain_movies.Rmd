...
```
Despite my best attempts at downloading and installing 'USAboundariesData', the package would not appear in my library. I ran the script by manually adding the datasets to my project folder and loading to the environment from that folder.

I was unable to create/play the video because I am missing "ffmpeg" (I am in R 3.5.3). I was unable to get the program installed on my computer. Therefore, the script I wrote may not be capable of producing a video.